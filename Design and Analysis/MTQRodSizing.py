"""
Magnetorquer Rod Sizing Script
Note: here we maximise the magnetic moment at any operating voltage below Vbus
while meeting power constraint and not the maximum magnetic moment capability of the rod.
